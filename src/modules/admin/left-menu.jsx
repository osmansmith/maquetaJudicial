        ...
        <section className={css.menu}>
            ...
            <nav>
                <ul>
                    ...
                    <li className={location.pathname === "/Administrador/Escritos" ? active : ""}>                        
                        <img src={edit} alt=""/>                        
                        <Link to={'Escritos'}>Escritos</Link>
                    </li>
                    <li className={location.pathname === "/Administrador/Causas" ? active : ""}>                        
                        <img src={balance} alt=""/>                         
                        <Link to={'Causas'}>Causas</Link>
                    </li>
                    <li className={location.pathname === "/Administrador/Clientes" ? active : ""}>                        
                        <img src={people} alt=""/>                         
